        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <nav className="hidden sm:flex items-center gap-8 font-sans text-xs font-semibold tracking-widest uppercase">
            <button
              ...
              className="theme-muted-strong hover:text-[var(--theme-text)] transition-colors cursor-pointer"
            >
              KOLEKSI KEBAYA
            </button>
            <a
          ...
          <div>
            <button
              type="button"
              onClick={scrollToCatalog}
              className="theme-primary-action text-[10px] sm:text-xs font-sans font-semibold tracking-widest uppercase px-4.5 py-3 transition-all duration-300 flex items-center gap-1.5 shadow-xs cursor-pointer"
            >
              LIHAT KOLEKSI
            </button>
          </div>
            ...
            <div className="md:col-span-3 space-y-4">
              ...
              <ul className="theme-inverse-muted space-y-2 text-xs sm:text-sm">
                <li>
                  <button
                    onClick={scrollToCatalog}
                    className="hover:text-[var(--theme-background)] transition-colors text-left"
                  >
                    Katalog Kebaya
                  </button>
                </li>
