  ...
  return (
    <main className="min-h-screen bg-neutral-950 text-white flex items-center justify-center px-4 py-10">
      <section className="w-full max-w-sm">
        <div className="mb-8">
          <div className="mb-5 flex h-12 w-12 items-center justify-center bg-white text-neutral-950">
        ...
        <form action={signInWithGoogle}>
          <button
            type="submit"
            className="flex h-12 w-full items-center justify-center gap-3 bg-white px-4 text-sm font-semibold text-neutral-950 transition-colors hover:bg-neutral-200"
          >
            <span className="flex h-5 w-5 items-center justify-center border border-neutral-300 text-xs font-bold">
              G
            </span>
