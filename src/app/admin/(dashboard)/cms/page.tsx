      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-neutral-500 mt-1">
            Manage fixed content sections of the public website.
          </p>
        </div>
        <button className="bg-neutral-900 text-white px-4 py-2.5 text-sm font-medium flex items-center gap-2 hover:bg-neutral-800 transition-colors">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 bg-neutral-50 border border-neutral-200 text-sm focus:outline-none focus:ring-2 focus:ring-neutral-900 focus:bg-white transition-all"
              />
            </div>
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-2 bg-neutral-50 border border-neutral-200 text-sm focus:outline-none focus:ring-2 focus:ring-neutral-900 focus:bg-white transition-all resize-none"
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-neutral-700 mb-1">Hero Image</label>
              <div className="flex items-center justify-center w-full h-32 px-4 py-6 border-2 border-dashed border-neutral-300 bg-neutral-50 hover:bg-neutral-100 transition-colors cursor-pointer">
        ...
        <div className="bg-white border border-neutral-200 shadow-sm p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-2 mt-2">
              ...
              />
              <label htmlFor="show-promo" className="text-sm text-neutral-700">
                Show promotion banner active
              </label>
            </div>
          </div>
        </div>
