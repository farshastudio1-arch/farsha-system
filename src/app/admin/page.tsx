  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-neutral-500 mt-1">Welcome back. Here is what is happening with your catalog today.</p>
      </div>
      ...
      <div className="bg-white rounded-xl border border-neutral-200 shadow-sm p-6">
        ...
        <div className="space-y-4">
          {[
            { action: 'Status changed', item: 'Kebaya Modern Brokat (KMB-01)', status: 'Rented', time: '2 hours ago' },
            { action: 'New item added', item: 'Kebaya Klasik Payet (KKP-05)', status: 'Available', time: '5 hours ago' },
            { action: 'Status changed', item: 'Kebaya Bludru Hitam (KBH-02)', status: 'Maintenance', time: '1 day ago' },
            { action: 'Status changed', item: 'Kebaya Kutu Baru (KKB-11)', status: 'Available', time: '1 day ago' },
          ].map((activity, i) => (
            <div key={i} className="flex items-start justify-between py-3 border-b border-neutral-100 last:border-0 last:pb-0">
              <div>
