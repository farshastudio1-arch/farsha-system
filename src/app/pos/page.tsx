...
const INITIAL_ITEMS: PosItem[] = [
  ...
  },
  {
    ...
    price: 200000,
    imageUrl: 'https://images.unsplash.com/photo-1616035079860-2eb311df93c5?auto=format&fit=crop&q=80&w=400',
  },
  {
    id: '3',
    code: 'KB-003',
    ...
    status: 'maintenance',
    price: 350000,
    imageUrl: 'https://images.unsplash.com/photo-1598032729987-a2f026938a14?auto=format&fit=crop&q=80&w=400',
  },
  {
    id: '4',
    code: 'KB-004',
    ...
    status: 'available',
    price: 250000,
    imageUrl: 'https://images.unsplash.com/photo-1578330756775-53c822e11801?auto=format&fit=crop&q=80&w=400',
  },
  {
    id: '5',
    code: 'KB-005',
    ...
    status: 'archived',
    price: 800000,
    imageUrl: 'https://images.unsplash.com/photo-1555529733-0e670560f7e1?auto=format&fit=crop&q=80&w=400',
  },
];
      ...
      <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-200 flex flex-col md:flex-row gap-4">
        ...
        <div className="flex items-center gap-2 sm:w-auto w-full">
          ...
          <select
            ...
            className="block w-full sm:w-48 pl-3 pr-10 py-2.5 text-base border border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-lg transition-colors"
          >
